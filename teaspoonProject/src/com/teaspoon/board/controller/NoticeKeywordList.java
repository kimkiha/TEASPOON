...
/**
 * Servlet implementation class NoticeKeywordList
 */
@WebServlet("/noticeKeywordList.bo")
public class NoticeKeywordList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NoticeKeywordList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//* listCount : 총 게시글 갯수
		listCount = new BoardService().getMagazineKeywordListCount(noticeKeyword);
		...
		ArrayList<Board> list = new BoardService().noticeKeywordList(noticeKeyword, pi);
		...
		request.setAttribute("noticeKeyword", noticeKeyword);
		
		RequestDispatcher view = request.getRequestDispatcher("views/admin/admin_notice.jsp");
