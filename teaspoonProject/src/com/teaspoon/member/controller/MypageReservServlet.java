...
/**
 * Servlet implementation class MypageReservServlet
 */
@WebServlet("/myReserv.me")
public class MypageReservServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MypageReservServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new MemberService().getreservListCount(userNo);
		...
		ArrayList<Member> list=  new MemberService().SelectReservCafe(userNo,pi);
		request.setAttribute("pi", pi);
		request.setAttribute("list", list);
		RequestDispatcher view = request.getRequestDispatcher("views/mypage/mypage_reserv.jsp");
