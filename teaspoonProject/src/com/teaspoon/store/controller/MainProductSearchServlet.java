...
/**
 * Servlet implementation class MainProductSearchServlet
 */
@WebServlet("/searchItem.st")
public class MainProductSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MainProductSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("views/store/itemSearchList.jsp");
