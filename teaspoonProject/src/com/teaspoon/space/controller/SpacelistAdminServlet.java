...
/**
 * Servlet implementation class SpacelistAdminServlet
 */
@WebServlet("/Spacelist.sp")
public class SpacelistAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SpacelistAdminServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//* listCount : 총 게시글 갯수
		listCount = new SpaceService().getSpaceListCount();
		...
		RequestDispatcher view = request.getRequestDispatcher("/views/admin/admin_reservation.jsp");
