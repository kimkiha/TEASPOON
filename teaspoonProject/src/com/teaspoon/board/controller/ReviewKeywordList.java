...
/**
 * Servlet implementation class ReviewKeywordList
 */
@WebServlet("/reviewKeywordList.st")
public class ReviewKeywordList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReviewKeywordList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//* listCount : 총 게시글 갯수
		listCount = new ProductService().getReviewKeywordListCount(reviewKeyword);
		...
		ArrayList<Review> list = new ProductService().selectReviewKeywordList(reviewKeyword, pi);
		...
		request.setAttribute("reviewKeyword", reviewKeyword);
