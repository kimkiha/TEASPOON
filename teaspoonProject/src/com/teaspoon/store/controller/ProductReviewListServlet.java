...
/**
 * Servlet implementation class ProductReviewListServlet
 */
@WebServlet("/review.st")
public class ProductReviewListServlet extends HttpServlet {
     ...
     */
    public ProductReviewListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//-------------------- 페이징처리 -----------------
				...
				ArrayList<Review> list = new ProductService().selectProductReviewList(pi);
				//페이지바만들기위한 pi객체전달
