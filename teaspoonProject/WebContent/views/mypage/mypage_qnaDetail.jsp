			...
			<div class="contaniner">
				<div id="mypage">
					...
					<div id="mypage_menu_tab">
						...
						<a href="#" class=" float">나의배송지</a> <a href="#"
							class="active float">1:1문의</a> <a href="#" class="float">장바구니</a>
					</div>
						...
						<div class="mp-qna">
							...
							<div class="outer" align="center">
								<form action="" method="post">
									...
									<div></div>
									<a
										href="<%=contextPath %>/resources/thumbnail_upfiles/<%=at.getChangeName()%>"><%= at.getOriginName() %></a>
							</div>
							<% }else{ %>
							첨부파일이 없습니다
							<% }%>
