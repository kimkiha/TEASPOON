     ...
     <%@include file="../common/admin_sidebar.jsp" %>
        <div id="contents">
            <div id="c1">
                <div class="outer">
                    <p>공지사항 등록</p>
                    <form id="noticeInsertForm" action="noticeInsert.bo" method="post" enctype="multipart/form-data">
                		<table>
                 		   	<tr>
                        ...
                        <div class="btns" style="margin-top:20px">
                            <button type="button" style="width: 100px;"><a href="<%=contextPath%>/noticeAdminList.bo?currentPage=1">목록으로</a></button>
